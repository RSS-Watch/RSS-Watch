 ...
 */
public class SpritzSectionsLayout extends LinearLayout{
    public SpritzSectionsLayout(Context context) {
        super(context);
    }

    public SpritzSectionsLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SpritzSectionsLayout(Context context, AttributeSet attrs, int defStyleAttr) {
